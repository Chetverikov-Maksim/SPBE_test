...
USE_CLOUDSCRAPER = True  # Use cloudscraper to bypass Cloudflare/bot protection (recommended)

# Playwright settings (for bypassing bot protection)
# IMPORTANT: Set to True to bypass 403 errors (requires playwright browsers installed)
USE_PLAYWRIGHT = False  # Set to True to use Playwright instead of requests library
PLAYWRIGHT_BROWSER = "chromium"  # Options: "chromium", "firefox", "webkit"
PLAYWRIGHT_HEADLESS = True  # Run browser in headless mode (no GUI)
PLAYWRIGHT_TIMEOUT = 30000  # milliseconds to wait for page operations

# Selenium settings (deprecated - use Playwright instead)
USE_SELENIUM = False  # Legacy option
